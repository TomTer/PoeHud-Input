...
namespace ExileHUD.ExileHUD
{
	public class DangerAlert : HUDPlugin
	{
		...
		private void EntityList_OnEntityAdded(Entity entity)
		{
			...
			if (entity.IsAlive && entity.HasComponent<Monster>() && entity.HasComponent<ObjectMagicProperties>() && entity.GetComponent<ObjectMagicProperties>().Rarity >= MonsterRarity.Magic)
			{
